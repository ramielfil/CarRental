...
if (strlen($_SESSION["alogin"]) == 0) {
 ...
 ?>
				...
				<div class="stat-panel-title text-uppercase">Number of Users</div>
			</div>
			</div>
			...
			<div class="stat-panel-number h1 "><?php echo htmlentities($totalvehicle,); ?></div>
				<div class="stat-panel-title text-uppercase">Liste of cars</div></div>
			</div>
			...
			<div class="stat-panel text-center">
				<?php
					$sql2 = "SELECT id from t_reservation ";
			...
			<div class="stat-panel text-center">
				...
				<div class="stat-panel-title text-uppercase">Liste of brands</div>
			</div>
			</div>
			...
			<div class="row">
				...
				<div class="stat-panel text-center">
					<?php
						$sql4 = "SELECT id from t_subscribers ";
					...
					<div class="stat-panel-title text-uppercase">Liste of Subscibers</div>
				</div>
				</div>
				...
				<div class="stat-panel text-center">
					<?php
						$sql6 = "SELECT id from t_contact_us ";
				...
				<a href="manage-conact-us.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
				</div>
				</div>
				<div class="col-md-3">
				<div class="panel panel-default">
				...
				<div class="stat-panel text-center">
					<?php
						$sql5 = "SELECT id from t_feedbacks ";

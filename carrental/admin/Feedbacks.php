...
$eid=intval($_GET['eid']);
$status="0";
$sql = "UPDATE t_feedbacks SET status=:status WHERE  id=:eid";
...
$sql = "UPDATE t_feedbacks SET status=:status WHERE  id=:aeid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT t_users.FullName,t_feedbacks.UserEmail,t_feedbacks.Feedback,t_feedbacks.PostingDate,t_feedbacks.status,t_feedbacks.id from t_feedbacks join t_users on t_users.Emailid=t_feedbacks.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();

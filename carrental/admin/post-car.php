...
$c_image1=$_FILES["img1"]["name"];
$c_image2=$_FILES["img2"]["name"];
$c_image3=$_FILES["img3"]["name"];
$c_image4=$_FILES["img4"]["name"];
$c_image5=$_FILES["img5"]["name"];
...
$sql="INSERT INTO t_cars(car_title,car_brand,car_description,Price_Per_Day,Fuel_Type,Model_Year,SeatingCapacity,c_image1,c_image2,c_image3,c_image4,c_image5,AirConditioner,PowerDoorLocks,AntiLockBrakingSystem,BrakeAssist,PowerSteering,DriverAirbag,PassengerAirbag,PowerWindows,CDPlayer,CentralLocking,CrashSensor,LeatherSeats) VALUES(:vehicletitle,:brand,:vehicleoverview,:Price_Per_Day,:Fuel_Type,:Model_Year,:seatingcapacity,:c_image1,:c_image2,:c_image3,:c_image4,:c_image5,:airconditioner,:powerdoorlocks,:antilockbrakingsys,:brakeassist,:powersteering,:driverairbag,:passengerairbag,:powerwindow,:cdplayer,:centrallocking,:crashcensor,:leatherseats)";
...
$query->bindParam(':c_image1',$c_image1,PDO::PARAM_STR);
$query->bindParam(':c_image2',$c_image2,PDO::PARAM_STR);
$query->bindParam(':c_image3',$c_image3,PDO::PARAM_STR);
$query->bindParam(':c_image4',$c_image4,PDO::PARAM_STR);
$query->bindParam(':c_image5',$c_image5,PDO::PARAM_STR);
...
<?php $ret="select id,BrandName from t_brands";

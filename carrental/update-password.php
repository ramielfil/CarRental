...
$sql ="SELECT Password FROM t_users WHERE EmailId=:email and   Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update t_users set Password=:newpassword where EmailId=:email";
...
<form name="chngpwd" method="post" onSubmit="return valid4()">
            ...
            <div class="form-group">
               <input type="submit" value="Update" name="submit" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>

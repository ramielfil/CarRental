...
$newpassword=$_POST['newpassword'];
  $sql ="SELECT EmailId FROM t_users WHERE EmailId=:email and contact_PNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update t_users set Password=:newpassword where EmailId=:email and contact_PNumber=:mobile";
      ...
      <div class="modal-body">
        <div class="row">
          <div class="forgotpassword_wrap">
            <div class="col-md-12">
              <form name="chngpwd" method="post" onSubmit="return valid2();">
